...
local help_pages = {
	...
	["TECHNIC FUNCTIONALITY"] = {
		...
		"  generate_power(fuel) = energy, attempt to generate power",
		"    from fuel material. If no fuel specified, built-in generator will",
		"    attempt to generate energy according to your robot upgrade level",
		"    energy = min(\"diamon block\", \"mese block\", \"gold block\") / 40",
